...
def evaluate(model, env, gamma):
    ...
    while not done:
        ...
        # action = [random.randint(0,49)] + [random.randint(0,25)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_episode_length', type=int, default=7)
    ...
    for s in range(args.n_seed):
        ...
        for algo in algos:
            ...
            model = PPO.load("plotting/tb_results/trained_model/PPO_tensorboard_7step_50nodes_fixed_graph_complex_mlp_4_env_with_capacity_new_idea",env)
